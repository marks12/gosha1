...
const usualWssHandlersView = `package wsserver
...
const usualWssHandlersNonView = `package wsserver
...
var usualTemplateWssHandlersView = template{
	Path:    "./wsserver/handlers.go",
	Content: assignCurrentDateTime(assignMsName(usualWssHandlersView)),
}

var usualTemplateWssHandlersNonView = template{
	Path:    "./wsserver/handlers.go",
	Content: assignCurrentDateTime(assignMsName(usualWssHandlersNonView)),
}
