    ...
    export default {
        ...
        methods: {
            ...
            ValidIdUrl() {
                ...
                let re = /^\/[a-zA-Z0-9\/]+\/[0-9]{1,}[?a-zA-Z0-9\-=&_\[\]]{0,}$/;
                let route = this.getRouteUrl();
                if (!route.match(re)) {
                    this.setResponseCode(500);
                    this.setResponseStatusText("Wrong request url: " + route + ". Need url like: /some/123");
                    console.error("wrong request url", this.getRequestUrl(), "route:", route);
                    return false;
